...
# Read Julia packages from a text file and install them
JULIA_PACKAGES_FILE="$1"
if [ -f "$JULIA_PACKAGES_FILE" ]; then
    julia -e "
    import Pkg;
    Pkg.update();
    ...
    echo "Package file $JULIA_PACKAGES_FILE not found!"
    exit 1
fi
